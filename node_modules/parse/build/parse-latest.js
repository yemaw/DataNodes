...
(function() {
  ...
  // [the Python documentation](http://docs.python.org/libraries/functions.html#range).
...
(function(root) {
  ...
  _.extend(Parse.Error, /** @lends Parse.Error */ {
    ...
    /**
     * You must call Parse.initialize before using the Parse libraries.
     * @constant
     */
    NOT_INITIALIZED: 109,
...
(function(root) {
   ...
   * class, you must also include jQuery, or another libraries that provides a
...
(function(root) {
   ...
   * use this class, you must also include jQuery, or another libraries
