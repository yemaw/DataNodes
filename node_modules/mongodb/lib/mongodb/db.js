...
// Check if we have a the kerberos libraries
try {
  require('kerberos');
  hasKerberos = true;
} catch(err) {}
...
Db.prototype.authenticate = function(username, password, options, callback) {
  ...
  if(options.authMechanism == 'MONGODB-CR') {
    ...
    //
    // Kerberos libraries is not installed, throw and error
    if(hasKerberos == false) {
      console.log("========================================================================================");
      console.log("=  Please make sure that you install the Kerberos libraries to use GSSAPI                =");
      console.log("=                                                                                      =");
      ...
      console.log("========================================================================================");
      throw new Error("Kerberos libraries not installed");
    }

    if(process.platform == 'win32') {
      mongodb_sspi_authenticate(self, username, password, authdb, options, _callback);
    } else {
      // We have the kerberos libraries, execute auth process
